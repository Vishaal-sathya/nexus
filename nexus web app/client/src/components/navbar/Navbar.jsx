...
>
    {/* <div className="navbar" style={{ backgroundColor: (active || pathname !== "/") ? "#e85b24" : "#bf4b1d" }}></div>   */}
      <div className="container">
        ...
        <div className="logo">
        <span><img src="https://upload.wikimedia.org/wikipedia/commons/d/d7/Orange_small_logo.png" width='55px' alt="" /></span>
        ...
        {/* <Link className="link" to="/messages">
          ...
          <Link className="link" to='/dashboard'><span>Dashboard</span></Link>
          <Link className="link" to='/chatbot'><span>nexus AI</span></Link>
          <Link className="link" to='/calendar'><span>View Calendar</span></Link>
